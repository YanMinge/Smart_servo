...
extern uint8_t command_mode; // Command mode.
...
extern volatile uint16_t ForwardBytesRead;
extern volatile uint16_t Uart0SendBytes;
...
extern volatile int16_t smart_servo_speed_val;
extern volatile int16_t pre_smart_servo_speed_val;
