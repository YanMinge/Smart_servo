...
#define DEFAULT_BUZZER_FREQUENCE         1000
...
void sysex_process_online(void)
{
	...
	data_type = SHORT_16;
	read_next_sysex_data(&data_type, &pwm_value, ON_LINE);
	
	// excute.
	pwm_write(BUZZER_PIN, frequence_value, pwm_value);
}
